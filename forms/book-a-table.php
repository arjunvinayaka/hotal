<?php
  ...
  */
  ...
  $receiving_email_address = 'brvinayaka2@gmail.com';
  ...
  */
  ...
  $book_a_table->add_message( $_POST['date'], 'Date');
  $book_a_table->add_message( $_POST['time'], 'Time');
  $book_a_table->add_message( $_POST['people'], '# of people');
